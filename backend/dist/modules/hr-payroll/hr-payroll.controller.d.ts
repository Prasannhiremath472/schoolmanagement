...
export declare class HrPayrollController {
    private readonly hrPayrollService;
    constructor(hrPayrollService: HrPayrollService);
    ...
    getLeaves(q: PaginationDto, status?: string): Promise<{
        data: {
            id: string;
    ...
    approveLeave(id: string, status: string, userId: string): Promise<{
        data: {
            id: string;
            status: import("../../generated/school-client").$Enums.LeaveStatus;
            updatedAt: Date;
    ...
    getSalaries(q: PaginationDto, month?: number, year?: number): Promise<{
        data: {
            id: string;
            status: import("../../generated/school-client").$Enums.SalaryStatus;
            createdAt: Date;

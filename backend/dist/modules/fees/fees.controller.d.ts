...
export declare class FeesController {
    ...
    collectFee(dto: CollectFeeDto, userId: string): Promise<{
        data: {
            receiptNo: string;
            id: string;
            createdAt: Date;
    ...
    getStudentFees(studentId: string, academicYearId: string): Promise<{
        data: {
            student: {
                sections: ({
                    section: {
    ...
    getPayments(pagination: PaginationDto, studentId?: string, fromDate?: string, toDate?: string): Promise<{
        data: ({
            student: {
                admissionNo: string;
                firstName: string;
    ...
    getStats(academicYearId: string): Promise<{
        data: {
    ...
    createScholarship(dto: any): Promise<{
        data: {
            id: string;
            name: string;
            createdAt: Date;
    ...
    applyScholarship(dto: any): Promise<{
        data: {
            studentId: string;
    ...
    grantConcession(dto: any, userId: string): Promise<{
        data: {
            id: string;
            createdAt: Date;
            updatedAt: Date;

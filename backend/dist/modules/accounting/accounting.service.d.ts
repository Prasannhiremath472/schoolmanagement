...
export declare class AccountingService {
    ...
    createAccountHead(dto: any): Promise<{
        data: {
            id: string;
            name: string;
            createdAt: Date;
    ...
    getTransactions(query: Partial<PaginationDto> & {
        fromDate?: string;
        toDate?: string;
        type?: string;
    ...
    getProfitAndLoss(fromDate: string, toDate: string): Promise<{
        data: {
            income: {
                items: {
                    name: string;
    ...
    getLedger(accountHeadId: string, fromDate: string, toDate: string): Promise<{
        data: {
            account: {
                id: string;
                name: string;
    ...
    getExpenses(query: Partial<PaginationDto> & {
        fromDate?: string;
        toDate?: string;
        category?: string;
    }): Promise<{
    ...
    createExpense(dto: any, createdBy: string): Promise<{
        data: {
            description: string;
            id: string;
            createdAt: Date;

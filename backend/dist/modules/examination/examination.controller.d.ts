...
export declare class ExaminationController {
    ...
    createExamType(dto: any): Promise<{
        data: {
            id: string;
            name: string;
            isActive: boolean;
    ...
    getSchedules(classId?: string, academicYearId?: string, examTypeId?: string): Promise<{
        data: ({
            class: {
                name: string;
            };
    ...
    enterBulkMarks(dto: BulkMarksDto, userId: string): Promise<{
        data: {
            success: number;
            failed: number;
        };

...
export declare class HostelService {
    ...
    vacateStudent(studentId: string, leaveDate?: string): Promise<{
        data: {
            id: string;
            createdAt: Date;
            isActive: boolean;
    ...
    getAllAllocations(query: Partial<PaginationDto> & {
        hostelId?: string;
    }): Promise<{
        data: ({
            student: {
    ...
    getHostelFeeDues(hostelId: string, month: number, year: number): Promise<{
        data: {
            studentId: string;
            studentName: string;
            admissionNo: string;
    ...
    getHostelAttendance(hostelId: string, date: string): Promise<{
        data: {
            date: string;
            rooms: any[];
    ...
    getHostelStats(hostelId?: string): Promise<{
        data: {
            id: string;
            name: string;
            type: string;
